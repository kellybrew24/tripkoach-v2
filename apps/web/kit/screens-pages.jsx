      ...
      <Wrap style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: "var(--space-10)", alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
          {[
            ...
            ["phone", "Call the Accra office", "Mon to Fri, 09:00 to 17:00 GMT. For complex or group bookings.", "+233 53 324 4042", "var(--info-fg)"],
          ].map(([ic, t, d, v, col]) => (
          ...
          <div className="tk-card"><div className="tk-card__body" style={{ padding: "var(--space-5)" }}>
            ...
            <p className="tk-body-sm" style={{ color: "var(--text-muted)", margin: "6px 0 0" }}>P.O. Box CT 11125 · Cantonments, Accra<br />Mon to Sat, 08:00 to 18:00 GMT</p>
          </div></div>
        </div>
      </Wrap>
    </div>
